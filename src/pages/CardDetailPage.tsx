    ...
    return (
      <div className="bg-[#f7f9fb] min-h-screen flex items-center justify-center">
        <div className="text-center max-w-[400px] px-6">
          ...
          <h1 className="font-bold text-[24px] text-[#191c1e] mb-2">Card Not Found</h1>
          <p className="text-[14px] text-[#45464d] mb-6">We couldn't find the card you're looking for. It may have been removed or the link is incorrect.</p>
          <Link to="/credit-cards" className="inline-block bg-[#006c49] hover:bg-[#00583b] text-white font-semibold text-[14px] px-6 py-3 rounded-xl transition-colors">
            Browse All Cards
          </Link>
        </div>
      </div>
    ...
    <div className="bg-[#f7f9fb] min-h-screen">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-10 py-6 sm:py-8">
        ...
        <div className="flex items-center gap-2 text-[13px] text-[#45464d] mb-6 sm:mb-8 flex-wrap">
          ...
          <span>›</span>
          <span className="text-[#191c1e]">{card.name}</span>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-10">
          ...
          <div className="flex-1 min-w-0">
            {/* Card Image */}
            <div className={`bg-gradient-to-br ${card.gradient} rounded-2xl p-6 sm:p-8 mb-6 sm:mb-8 flex items-center justify-center min-h-[180px] sm:min-h-[220px] relative`}>
              ...
              <div className="text-center">
                <div className="text-white text-[10px] tracking-widest opacity-60 mb-2">{card.bankShort}</div>
                <div className="text-white font-bold text-[15px] sm:text-[18px] mb-4">{card.name.toUpperCase()}</div>
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="font-semibold text-[13px] text-[#45464d]">{card.bank}</span>
            </div>
            <h1 className="font-bold text-[24px] sm:text-[28px] lg:text-[32px] text-[#191c1e] mb-4 tracking-[-0.5px]">{card.name}</h1>

            {/* Rating + Match */}
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 mb-5 sm:mb-6">
              <div className="flex items-center gap-1">
                <span className="text-[#f59e0b] text-lg">★</span>
                <span className="font-bold text-[15px] text-[#191c1e]">{card.rating}</span>
              ...
              <div className="flex items-center gap-2 bg-[#f0faf5] border border-[rgba(108,248,187,0.5)] rounded-full px-3 py-1.5">
                ...
                <span className="text-[12px] sm:text-[13px] font-semibold text-[#006c49]">{card.match}% Match for you</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-[#e5e7eb] p-4 sm:p-5 mb-5 sm:mb-6 grid grid-cols-3 gap-3 sm:gap-4">
              <div>
                ...
                <div className="font-bold text-[16px] sm:text-[20px] text-[#191c1e]">₹{card.annualFee}</div>
              </div>
              <div>
                <div className="text-[11px] text-[#45464d] mb-1">Annual Fee</div>
                <div className="font-bold text-[16px] sm:text-[20px] text-[#191c1e]">₹{card.annualFee}</div>
                {card.feeNote && <div className="text-[11px] text-[#006c49]">{card.feeNote}</div>}
              </div>
              <div>
                <div className="text-[11px] text-[#45464d] mb-1">Best For</div>
                <div className="font-semibold text-[13px] sm:text-[15px] text-[#191c1e]">{card.bestFor}</div>
              </div>
            </div>
            ...
            <div className="flex gap-3 sm:gap-4 mb-8 sm:mb-10">
              ...
              <button
                ...
                className="flex-1 border border-[#c6c6cd] hover:border-[#191c1e] bg-white text-[#191c1e] font-semibold text-[14px] sm:text-[15px] py-3.5 sm:py-4 rounded-xl transition-colors flex items-center justify-center gap-2"
              >
                Compare
              </button>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-[#e5e7eb] p-5 sm:p-6 mb-7 sm:mb-8">
              <p className="text-[14px] sm:text-[15px] text-[#191c1e] mb-5">Cashback and rewards are earned based on your spending categories and can be redeemed through the {card.bank} portal.</p>
              <div className="flex flex-col gap-4">
                {card.rewardDetails.map((r) => (
